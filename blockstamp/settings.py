"""
Django settings for blockstamp project.
...
BITCOIN_PARAMS = os.environ.get("BLOCKSTAMP_BITCOIN_PARAMS", "testnet" if DEBUG else "mainnet")
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'stamper.context_processors.conf',
            ],
        },
    },
]

WSGI_APPLICATION = 'blockstamp.wsgi.application'
